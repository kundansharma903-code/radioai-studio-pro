...
def main():
    ...
    # Alt-Tab switcher, and (after Phase M's PyInstaller packaging)
    # embedded as the .exe file icon visible in Windows Explorer.
    # Loads from assets/icon.png — square 512×512 transparent PNG
    # generated by _build_icon.py from the source logo.
